...
## TODO
毎回RestAPI叩くの遅いからマークアップからCMS情報を抜きたい。
- 一回実装したことあるけどまぁまぁ複雑だった気がする
ページのテキスト情報もマークアップから動的に取得したい。(クライアント側でもphpファイル触れば更新できるようになる)

- まずcookieに情報を格納、それを使用してページをつくる
- その間にページもパースしてcookieの情報と違ったら更新、cookieの情報も更新案
